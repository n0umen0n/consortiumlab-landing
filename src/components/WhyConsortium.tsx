      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <ScrollReveal>
          <div className="mt-16 mb-20">
            ...
            <div className="mb-10 rounded-xl border border-white/[0.06] bg-white/[0.02] p-6 md:p-8">
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex items-center gap-16 md:gap-24">
                  <div className="flex flex-col items-center gap-1">
                    <svg className="w-5 h-5 text-white/20" viewBox="0 0 24 24" fill="none"><path d="M12 5v14m-4-4 4 4 4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                  <div className="flex flex-col items-center gap-1">
                    <svg className="w-5 h-5 text-white/20" viewBox="0 0 24 24" fill="none"><path d="M12 5v14m-4-4 4 4 4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-1.5">
                      {['Community', 'Social', 'Content', 'BizDev'].map(a => (
                        <span key={a} className="text-[10px] text-white/40 bg-white/[0.04] rounded px-2 py-0.5">{a}</span>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-1.5">
                      {['Full-Stack Dev', 'QA & Testing', 'Design', 'Analytics'].map(a => (
                        <span key={a} className="text-[10px] text-white/40 bg-white/[0.04] rounded px-2 py-0.5">{a}</span>
                      ))}
                    </div>
                  </div>
