...
export default function NewFactoryHomePage() {
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-10">
        <header className="rounded-3xl border border-white/15 bg-white/5 p-8 backdrop-blur-xl">
          <p className="text-sm uppercase tracking-[0.2em] text-cyan-200/80">Consortium Factory / New</p>
          ...
          <div className="mt-7 flex flex-wrap gap-4">
            ...
            <Link href="/" className="rounded-full border border-white/25 bg-white/5 px-6 py-3 font-medium transition hover:bg-white/10">Back to Landing</Link>
          </div>
